# -*- encoding: utf-8 -*-
# stub: actioncable 6.0.4 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/blob/v6.0.4/actioncable/CHANGELOG.md", "documentation_uri" => "https://api.rubyonrails.org/v6.0.4/", "mailing_list_uri" => "https://discuss.rubyonrails.org/c/rubyonrails-talk", "source_code_uri" => "https://github.com/rails/rails/tree/v6.0.4/actioncable" } if s.respond_to? :metadata=
